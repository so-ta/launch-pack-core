...
function renderTemplate(config, req, res, viewRootDirectory, template, renderObj) {
  return new Promise(function (resolve, reject) {
    try {
      ...
      renderObj = appendFunction(config, req, renderObj);
...
function appendFunction(config, req, json) {
