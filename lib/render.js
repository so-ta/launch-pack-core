...
function renderTemplate(config, req, res, viewRootDirectory, template, renderObj, actionAndParams) {
  return new Promise(function (resolve, reject) {
    try {
      ...
      renderObj = appendFunction(config, req, renderObj, actionAndParams);
...
function appendFunction(config, req, json, actionAndParams) {
